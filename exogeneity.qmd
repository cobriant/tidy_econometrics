...
In [classwork 1](#cw1-deriving-ols-estimators-analytical), I asked you to take the formula above and show that:
...
Recall the [definition of the variance of a random variable](math.html#variance-and-covariance): $Var(Z) = E\left[(Z - E[Z])^2\right]$.
...
[Classwork 4: hypothesis testing](classwork.html#cw4-hypothesis-testing-analytical)
