...
We've already learned that estimators can be **biased** or **unbiased**. This chapter introduces a new property for estimators: estimators can be **consistent** or **inconsistent**.
